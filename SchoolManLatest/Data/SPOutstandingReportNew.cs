...
{
   public class SPOutstandingReportNew:BaseReference
    {
        private SP_OutstandingReportNew_Result outstand;
        public SPOutstandingReportNew(SP_OutstandingReportNew_Result obj) { outstand = obj; }
