...
{
    public class PurchaseUpdate:BaseReference
    {
        private tb_Purchase stock;
        public PurchaseUpdate(tb_Purchase obj) { stock = obj; }
        public PurchaseUpdate(long Id) { stock = _Entities.tb_Purchase.FirstOrDefault(z => z.CategoryId == Id); }
