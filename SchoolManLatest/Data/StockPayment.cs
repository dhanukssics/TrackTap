...
{
    public class StockPayment : BaseReference
    {
        private tb_StockPayment payment;
        public StockPayment(tb_StockPayment obj) { payment = obj; }
        public StockPayment(long id) { payment = _Entities.tb_StockPayment.FirstOrDefault(z => z.PaymentId == id); }
